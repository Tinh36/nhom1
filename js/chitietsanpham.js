...
window.onload = function () {
    ...
    var tags = [" Đồ ăn khô"," đồ ăn ướt"," Hat"];
...
function phanTich_URL_chiTietSanPham() {
    ...
    // Đổi title
    document.title = nameProduct + ' - Thế gio';
    ...
    var s = addThongSo('Loại', sanPhamHienTai.detail.screen);
    s += addThongSo('Đói tượng sử dụng', sanPhamHienTai.detail.os);
    s += addThongSo('Chi Tiết', sanPhamHienTai.detail.camara);
    ...
    // Hình nhỏ
    addSmallImg("img/products/h1.jpg");
    addSmallImg("img/products/h7.jpg");
    addSmallImg("img/products/h8.jpg");
    addSmallImg("img/products/tinh.jpg");
    addSmallImg("img/products/tinh2.jpg");
